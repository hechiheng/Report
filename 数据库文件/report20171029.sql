...
-- Records of t_admin
-- ----------------------------
INSERT INTO `t_admin` VALUES ('1', 'admin', 'c4ca4238a0b923820dcc509a6f75849b', '', '', '9', '1477469251', '0');
...
INSERT INTO `t_member` VALUES ('2', '111', '111', '0', '111定点', null, '', '0', '', null, null, '1477466340', null, null, '1', '0');
INSERT INTO `t_member` VALUES ('3', '222', '232', '1', '2323', '2323', '2017-10-24', '', '', '2332', '', '1508942544', null, null, '1', '0');
INSERT INTO `t_member` VALUES ('4', '333', 'c4ca4238a0b923820dcc509a6f75849b', '1', '333的丰富的', '23432433333', '2017-10-18', '234222水电费', '2342222', '2343242222', '23422', '1508942916', '1509182217', null, '1', '0');
INSERT INTO `t_member` VALUES ('5', '444', 'c4ca4238a0b923820dcc509a6f75849b', '1', '水电费', '2323', '2017-10-11', '???????????', '23', '23', '23', '1508944535', null, null, '1', '0');
...
INSERT INTO `t_menu` VALUES ('32', '用户管理', '4', '1', '1', '1', 'admin_index.php');
...
CREATE TABLE `t_role` (
  ...
  `isdisabled` tinyint(1) DEFAULT '0' COMMENT '是否禁用',
  `updatetime` int(10) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `status` (`isvalid`)
...
CREATE TABLE `t_role_user` (
  `roleid` mediumint(9) unsigned DEFAULT NULL,
